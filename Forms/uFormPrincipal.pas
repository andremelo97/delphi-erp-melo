...
uses
  ...
  uFormFiltroVendas, uFormConfigBanco, uFormFiltroUsuario, uFormCadastroUsuario,
  uFormLogin;
...
type
  TFormPrincipal = class(TAdvToolBarForm)
    ...
    procedure btnBuscaUsuariosClick(Sender: TObject);
...
procedure TFormPrincipal.btnBuscaUsuariosClick(Sender: TObject);
begin
...
procedure TFormPrincipal.btnCadastroUsuarioClick(Sender: TObject);
begin
